1. The R code in run_analysis.R proceeds under the assumption that the zip file available 
...
Output1:Merge training and the test sets to create one data set
...
To create extractedData with the selected columns in requiredColumns and look dimension of the 
requiredColumns.
...
Output5: from the data set in step 4, creates a second, 
